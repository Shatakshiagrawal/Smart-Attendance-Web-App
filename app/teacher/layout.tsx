        ...
        <Sidebar className="border-r border-border/50 hidden md:flex">
          ...
          <SidebarContent className="p-4">
            <SidebarMenu>
              ...
              <SidebarMenuItem>
                <SidebarMenuButton onClick={logout} className="flex items-center space-x-3 px-3 py-2 rounded-lg transition-colors hover:bg-sidebar-accent hover:text-sidebar-accent-foreground">
